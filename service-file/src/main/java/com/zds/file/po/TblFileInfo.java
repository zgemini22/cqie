...
@NoArgsConstructor
@AllArgsConstructor
@TableName("tbl_file_info")
@ApiModel(value = "TblFileInfo对象", description = "文件上传记录")
public class TblFileInfo implements Serializable {
    ...
    public static LambdaQueryWrapper<TblFileInfo> getWrapper() {
