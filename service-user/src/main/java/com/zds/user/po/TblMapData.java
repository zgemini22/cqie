...
@NoArgsConstructor
@AllArgsConstructor
@TableName("tbl_map_data")
@ApiModel(value = "TblMapData对象", description = "地图配置")
public class TblMapData implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelPropertyCheck(value = "地图配置ID")
    ...
    @ApiModelPropertyCheck(value = "地图URL")
    ...
    public static LambdaQueryWrapper<TblMapData> getWrapper() {
