...
@NoArgsConstructor
@AllArgsConstructor
public class AdminKpiNormListResponse {
    ...
    private List<AdminKpiNormListResponse> children;

    /**
     * 平行集合转树状集合
     */
    public static List<AdminKpiNormListResponse> buildTree(List<AdminKpiNormListResponse> classifyList, Long pid) {
        List<AdminKpiNormListResponse> treeList = new ArrayList();
        for (AdminKpiNormListResponse classify : classifyList) {
